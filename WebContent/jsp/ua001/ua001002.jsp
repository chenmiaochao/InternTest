...
<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%@ page import = "sdcj.nsk.pj001.dto.UridenJViewDto" %>
<%@ page import = "java.util.List" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
<html>
<head>
 <meta charset="UTF-8">
 <title>売上伝票 照会画面</title>
</head>
...
<body>
  ...
  <!-- ERRORS -->
  <c:set var="NoRecordsErr" value="${ requestScope.NORECORDSERR }"/>
            ...
            <td>
             ...
             <table border="0" cellspacing="2" cellpadding="0" width="100%">
              ...
              <tr>
               ...
               <td align="center">&gt;&gt;</td>
               <td align="left"><b>売上伝票 照会画面</b></td>
               <td></td>
              </tr>
             </table>
              ...
              <tr height="250">
               <td align="center" valign="top">
                <table border="0" cellspacing="0" cellpadding="5" bordercolor="#888888" width="540" height="150">
                 ...
                 <tr>
                  <c:choose>
                   <c:when test="${ empty NoRecordsErr }">
                    <td align="center" valign="top">
                     <form action="">
                   ...
                   <c:otherwise>
                    <c:out value="${ NoRecordsErr }"></c:out>
                   </c:otherwise>
                  </c:choose>
                ...
                <table>
                 ...
                 <tr>
                  <td align="center" valign="top">
                   <input type="submit" value="　戻る　" onclick="location.href='UA001002_BackAction'"/>
                  </td>
                 </tr>
                </table>
               </td>
