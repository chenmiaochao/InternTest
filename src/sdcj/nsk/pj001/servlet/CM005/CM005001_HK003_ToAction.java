...
/**
 * Servlet implementation class CM005001_HK003_ToAction
 */
@WebServlet("/CM005001_HK003_ToAction")
public class CM005001_HK003_ToAction extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public CM005001_HK003_ToAction() {
		super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			if (uid.equals("CM005001")) {
				session.setAttribute("TANTOUORDER", "to");
