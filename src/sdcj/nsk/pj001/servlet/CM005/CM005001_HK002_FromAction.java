...
/**
 * Servlet implementation class CM005001_HK002_FromAction
 */
@WebServlet("/CM005001_HK002_FromAction")
public class CM005001_HK002_FromAction extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public CM005001_HK002_FromAction() {
		super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			if (uid.equals("CM005001")) {
				session.setAttribute("TOKUIORDER","from");
