...
/**
 * Servlet implementation class HK003001_SearchAction
 * @author nguyen.hungminh
 */
@WebServlet("/HK003001_SearchAction")
public class HK003001_SearchAction extends HttpServlet {
	private static final long serialVersionUID = 1L;

    /**
     * @see HttpServlet#HttpServlet()
     */
    public HK003001_SearchAction() {
        super();
