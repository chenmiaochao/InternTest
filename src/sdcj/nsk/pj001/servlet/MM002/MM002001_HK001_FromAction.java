...
/**
 * Servlet implementation class MM002001_HK001_FromAction
 */
@WebServlet("/MM002001_HK001_FromAction")
public class MM002001_HK001_FromAction extends HttpServlet {
	private static final long serialVersionUID = 1L;

    /**
     * @see HttpServlet#HttpServlet()
     */
    public MM002001_HK001_FromAction() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			if (uid.equals("MM002001")) {
				session.setAttribute("SHOHINORDER","from");
