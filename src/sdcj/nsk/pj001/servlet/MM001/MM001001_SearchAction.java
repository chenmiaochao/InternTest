...
/**
 * Servlet implementation class MM001001_SearchAction
 */
@WebServlet("/MM001001_SearchAction")
public class MM001001_SearchAction extends HttpServlet {
	private static final long serialVersionUID = 1L;

    /**
     * @see HttpServlet#HttpServlet()
     */
    public MM001001_SearchAction() {
        super();
