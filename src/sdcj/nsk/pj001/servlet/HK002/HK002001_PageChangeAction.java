...
/**
 * Servlet implementation class HK002001_PageChangeAction
 * @author nguyen.hungminh
 */
@WebServlet("/HK002001_PageChangeAction")
public class HK002001_PageChangeAction extends HttpServlet {
	private static final long serialVersionUID = 1L;

    /**
     * @see HttpServlet#HttpServlet()
     */
    public HK002001_PageChangeAction() {
        super();
