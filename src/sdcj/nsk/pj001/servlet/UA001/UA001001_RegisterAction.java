...
/**
 * Servlet implementation class UA001001_RegisterAction
 */
@WebServlet("/UA001001_RegisterAction")
public class UA001001_RegisterAction extends HttpServlet {
	private static final long serialVersionUID = 1L;

    /**
     * @see HttpServlet#HttpServlet()
     */
    public UA001001_RegisterAction() {
        super();
